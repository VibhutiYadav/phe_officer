                ...
                Positioned(
                    child: Align(
                      ...
                      child: Container(
                          ...
                          child: Obx(()=> Text("${controller.status.where((item) => item['service_type'] == controller.services[index]['type']).length}",textScaleFactor: 1,style:TextStyle(color:Colors.white,fontSize: 12)))),
                    )),
